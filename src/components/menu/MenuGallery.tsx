    ...
    <section className="py-24 bg-vintage-cream">
      <div className="max-w-7xl mx-auto px-6">
        <div className="text-center mb-16">
          <h2 className="font-ultra text-4xl md:text-5xl text-muted-brown uppercase mb-4">
            Our Sanctuary
          </h2>
          <p className="text-muted-brown/60 tracking-widest uppercase text-sm">
          ...
          {galleryImages.map((image, idx) => (
            ...
            >
              ...
              <div className="absolute inset-0 bg-black/20 opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex items-end p-6">
                {image.caption && (
                  <p className="text-white font-ultra text-lg leading-snug">
                    {image.caption}
                  </p>
                )}
              </div>

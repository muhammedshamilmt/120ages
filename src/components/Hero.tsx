    ...
    <section className="relative h-screen flex flex-col justify-between overflow-hidden bg-vintage-cream">
      ...
      <div className="relative w-full p-6 md:p-12 z-20">
        <div className="flex flex-col items-center">
          <h1 className="text-[12vw] leading-[0.85] font-ultra text-vintage-red uppercase tracking-[-0.05em] text-center ultra-regular drop-shadow-sm">
            Sip Healthy<br />
            <span className="ml-[5vw]">Live Longer</span>
          </h1>

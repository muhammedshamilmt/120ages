...
export function AboutPlace() {
  return (
    <section className="py-24 bg-[#1A1A1A] border-t border-vintage-cream/10">
      <div className="max-w-7xl mx-auto px-6">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          <div>
            ...
            <h2 className="text-5xl md:text-8xl font-ultra text-vintage-cream uppercase leading-[0.85] tracking-tighter mb-8">
              Our <br />
              <span className="text-forest-green">Place</span>
            </h2>
            
            <p className="text-xl text-vintage-cream/80 font-medium leading-relaxed mb-12 max-w-md">
              Nestled in a quiet corner, our café invites you to unwind and nourish your body and mind.
            </p>

            <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
              <div>
                <h4 className="font-ultra text-forest-green text-sm tracking-widest uppercase mb-4 opacity-50">
                  Address
                </h4>
                <p className="text-2xl font-ultra text-vintage-cream uppercase">
                  123 Herbal Lane
                </p>
              </div>
              <div>
          ...
          <div className="relative aspect-square md:aspect-video lg:aspect-square bg-black border-2 border-vintage-cream/20 p-4 group">
            ...
            {/* Decorative Overlay */}
            <div className="absolute inset-0 pointer-events-none border-[20px] border-[#1A1A1A]/80 m-4" />

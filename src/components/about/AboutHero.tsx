...
export function AboutHero() {
  return (
    <section className="relative min-h-[70vh] flex flex-col items-center justify-center overflow-hidden bg-vintage-cream pt-20">
      ...
      <div className="relative z-10 text-center px-6">
        ...
        <h1 className="text-[12vw] md:text-[8vw] font-ultra text-muted-brown leading-[0.85] uppercase tracking-tighter mb-8">
          Our <br />
          <span className="text-forest-green">Story</span>
        </h1>
        
        <div className="max-w-2xl mx-auto">
          <p className="text-lg md:text-xl text-muted-brown/80 font-medium leading-relaxed italic">
      ...
      <div className="absolute bottom-0 left-0 w-full h-px bg-muted-brown/20 flex justify-center">
        <div className="bg-vintage-cream px-4 -translate-y-1/2 font-ultra text-muted-brown text-xs tracking-widest uppercase">
          Crafting Moments
        </div>
      </div>
    </section>
